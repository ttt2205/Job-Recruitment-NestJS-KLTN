...
export class CompanyController {
  ...
  async GetListPagination(@Query() queryPagination: CompanyQueryDto) {
    const { data, total } =
      await this.companyService.GetListPagination(queryPagination);
  ...
  @Patch(':id')
  @HttpCode(HttpStatus.OK)
  async UpdatePartitionCompany(
    @Param('id') id: string,
    @Body(new ValidationPipe()) data: UpdateCompanyDto,
  ) {
